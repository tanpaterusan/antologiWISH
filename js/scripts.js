...
window.addEventListener("load", function () {
  ...
  form.addEventListener("submit", function (e) {
    ...
    // Define the URL here for cleaner code
    const whatsappUrl = "https://chat.whatsapp.com/FxWEJCTPWeiLtGtxo5De8X";
    ...
    fetch(action, {
      ...
      .then(() => {
        // 1. Show the alert with a clear instruction
        alert(
          "Terima kasih telah mendaftar workshop!\nBergabung ke grup WA: \n bit.ly/grupWAantologiWISH ."
        );

        // 2. Open the URL in a new tab immediately after the user dismisses the alert
...
$.getJSON("data/list.json", function (data) {
  ...
  $.each(karya, function (i, data) {
    ...
    $("#daftar-karya").append(
      `<div class="card border-success" ><div class="card-body"> Judul: <b>` +
        data.judul +
        `</b> <br> Penulis: ` +
        data.penulis +
        `, ` +
